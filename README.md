...
## Running demo
We provide demos for all datasets as references. The Tutorials folder () includes the running results of SpaBatch on all datasets used in this study, along with the code for downstream analysis. The results of all baseline methods can be found in the Baselines folders ().
